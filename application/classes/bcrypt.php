...
class Bcrypt {
	...
	/**
	 * Hashes a password using BLOWFISH for secure storage
	 *
	 * @param  string  User's password
	 * @param  int     Number of iterations to use (2^x)
	 * @return string  Hashed password with embedded salt
	 */
	public static function hash($password, $work_factor = 0)
	{
		// Check to make sure BLOWFISH is supported
	 ...
	 * @param  function  Previous hashing function used for updating to bcript
	 * @return bool
	 */
	public static function check($password, $stored_hash, $legacy_handler = NULL)
	{
		...
		// Check if using old hasing method
	...
	/**
	 * Tests if stored hash is using non-bcrpyt method
	 *
	 * @param  string  Stored hash
	 * @return bool
	 */
